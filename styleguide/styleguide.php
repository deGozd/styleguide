...
<!-- Install Canvas -->
<div class="canvas">
    <img src="pages/homepage/HomePage.png">
</div>
...
<div class='sg-container' class="ui-widget-content">
    ...
    <div class='sg-grabber'>
        ...
        <div class="functions"><a class="close"><i class="fa fa-remove"></i></a></div>
        <div class="clear"></div>
    </div>
    ...
    <div class="sg-box">
        <div class="sg-text-box sg-hide">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <input type='text' class="sg-colour" name="stylecolour"/>
                <script>
                    $(".sg-colour").spectrum({
                        color: "#000",
                        ...
                        showPalette:true,
                        palette: [
                            ['red', 'yellow', 'green', 'blue', 'violet', 'azure', 'aliceblue', 'antiquewhite', 'aqua', 'aquamarine', 'azure', 'beige', 'bisque', 'black', 'blanchedalmond', 'blue', 'blueviolet', 'brown', 'burlywood', 'cadetblue', 'chartreuse', 'chocolate', 'coral', 'cornflowerblue', 'cornsilk', 'crimson']
                        ]   
                    });
                </script>
                ...
                <div class="sg-options">
                    ...
                    ?>
                    <input type="submit" class="sg-save">
...
<div class="sg-notes"> 
    <?php  
    $u = 0;
    $sql = "SELECT x, y, stylecolour, fontsize, font, fontcolour, styletitle, additional FROM pagetitle";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        // output data of each row
        while($row = $result->fetch_assoc()) {  
